<?php include('header.inc.php');
    if(isset($_GET['type']) && $_GET['type']!=''){
        ...
        if($_GET['type']=='change'){
            ...
            $res = mysqli_query($conn,"UPDATE `category` SET  `status`='$status' WHERE `id`='$id'");
        }
        if($_GET['type']=='delete'){
...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header mb-3">
          ...
          <a href="addcategory.php?action=add"><button class="btn btn-primary pull-right " style="margin-bottom:10px">Add category</button></a>
          <!-- display session  -->
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <?php $q = "SELECT * FROM `category` ORDER BY name ASC";
                        ...
                        while($row = mysqli_fetch_assoc($res)){ ?>
                                ...
                                <td><?php
                                    ...
                                    if($image!=''){ ?>
                                            <img src="../media/category/<?php echo $image?>" alt="image" width="65px" height="65px">
                                   <?php }else{echo 'Null'; } 
                                 ?></td>
                                ...
                                <a  href="addcategory.php?action=update&id=<?php echo $row['id'];?>"><button class="btn btn-primary">Edit</button></a>
                            </td>
